'''
Start of strings.py from cuwo.
Retrieved from https://github.com/matpow2/cuwo/blob/master/cuwo/strings.py
on May 25th, 2019
'''
...
'''
Start of constants.py from cuwo
Retrieved from https://github.com/matpow2/cuwo/blob/master/cuwo/constants.py
on May 25th, 2019
...
# outdated terms: chunk, sector
# new terms: zone, region
BLOCK_SCALE = 0x10000
